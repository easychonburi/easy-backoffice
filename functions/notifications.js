...
exports.line=async message=>{
  ...
  const text=message,messages=[];for(let i=0;i<text.length;i+=4500)messages.push({type:'text',text:text.slice(i,i+4500)});
